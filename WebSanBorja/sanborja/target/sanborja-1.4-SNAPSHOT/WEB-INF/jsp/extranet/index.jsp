                ...
                error : function(jqXHR, textStatus, errorThrown) { 
                    ...
                    { 
                        if(tipo==1){
                            ...
                            var $formEl = $('<form class="mui-form" style="padding:10px"><div ><h3>Mensaje del Sistema </h3><hr/></div><div>  <h4 style="color:red">DNI no encontrado</h4></div><div class="mui--text-right"><button class="mui-btn mui-btn--raised" onClick="return closeModal();"> Cerrar</button></div></div></form>');
                            $modalEl.append($formEl);
                            mui.overlay('on', $modalEl.get(0));
